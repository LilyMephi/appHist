...
double ResizeDialog ::xMin() const { return xMinEdit->text().toDouble(); }
double ResizeDialog ::xMax() const { return xMaxEdit->text().toDouble(); }
double ResizeDialog ::yMin() const { return yMinEdit->text().toDouble(); }
double ResizeDialog ::yMax() const { return yMaxEdit->text().toDouble(); }
